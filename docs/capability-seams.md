...
| `ctx.agentTeams` | `seam` | [`experimental-agent-team`](../packages/experimental/agent-team) | - | [`experimental-tool-agent-team`](../packages/experimental/tool-agent-team), [`experimental-client-ui-agent-team`](../packages/experimental/client-ui-agent-team) | - | Owns the implicit-root roster, durable peer mailbox, shared task DAG, and generated Team Remote methods; it routes DSH teammates through continuable children and external teammates through Fiber-scoped durable provider registrations. |

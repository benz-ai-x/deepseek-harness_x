...
Source: [`packages/experimental/agent-team/src/types.ts:203`](../packages/experimental/agent-team/src/types.ts)

<a id="deepseek-aidsh-experimental-agent-team-claude-code"></a>

## `@deepseek-ai/dsh-experimental-agent-team-claude-code`

Requires: `agentTeams` · `subprocess`
...
Source: [`packages/experimental/agent-team-claude-code/src/index.ts:71`](../packages/experimental/agent-team-claude-code/src/index.ts)

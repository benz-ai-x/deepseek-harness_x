...
export const RELEASED_V0_EVENT_DISPOSITIONS: Readonly<Record<string, ReleasedV0PayloadDisposition>> = Object.freeze({
  ...
  'team/message/delivered': disposition(['version', 'teamId', 'messageId', 'targetId'], ['nativeTurnId']),
  'team/message/queued': disposition(['version', 'teamId', 'message']),
  'team/message/request-committed': disposition(['version', 'teamId', 'receipt', 'message']),
  'team/native-operation/committed': disposition(['version', 'teamId', 'receipt'], ['kind', 'message', 'task']),

...
/**
 * Brand a canonical native-operation digest.
 * @param id - operation identity generated by the Team owner.
 * @returns the same value branded as a native operation identity.
 */
export function TeamNativeOperationId(id: string): TeamNativeOperationId {
  return brandString<TeamNativeOperationId>(id)
}

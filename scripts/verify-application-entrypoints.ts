...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ...
  ['packages/experimental/agent-team-claude-code/tests/fixtures/loader/driver.ts', 'test-only subprocess driver'],
  ['packages/experimental/agent-team-codex/tests/fixtures/loader/driver.ts', 'test-only subprocess driver'],

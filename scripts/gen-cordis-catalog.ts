...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GetTeamMessageRequest: 'agent-team.md',
  ListTeamMessagesRequest: 'agent-team.md',
  ...
  SubmitTeamMessageRequest: 'agent-team.md',
  SubmitTeamMessageResult: 'agent-team.md',
  SubmitTeamMessageValue: 'agent-team.md',
  TeammateEvaluationCreateRequest: 'agent-team.md',
  TeammateEvaluationCreateResult: 'agent-team.md',
  ...
  TeamMessageDetail: 'agent-team.md',
